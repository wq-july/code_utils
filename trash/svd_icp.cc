void ICP::findTransformation(const std::vector<Eigen::Vector3d>& pts_model,
  ...
  for (int n = 0; n < n_iters; n++) {
    ...
    // std::cout << "iter:" << n << " mathced size: " << pts_model_matched.size() << " " <<
    // pts_cloud_matched.size() << std::endl;
    ...
    // std::cout << "iter:" << n << " squared_dist_change: " << squared_dist_change << " cur
    // distance " << cur_squared_dist  << std::endl;
